        ...
        <div className="px-6 max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <Reveal>
            <div className="relative">
              <div className="aspect-[4/5] bg-rust rounded-sm overflow-hidden relative max-w-md">
                <div
            ...
            <Reveal delay={0.1}>
              <div className="space-y-4 text-ink-muted leading-relaxed font-light text-[0.95rem]">
                ...
                <p>
                  ...
                  clients. I care about the full design-to-deployment pipeline — from early wireframes and content strategy through to live implementation.
                </p>
                <p>
